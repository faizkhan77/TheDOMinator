...
const Chat = () => {
    ...
    return (
        <>
            ...
            <div
                className="container mx-auto p-4 min-h-screen transition-all duration-300"
                style={{
            ...
            >
                <div className="flex flex-col lg:flex-row">
                    {/* Team Members List */}
                    <div className="w-full lg:w-72 p-4 bg-gray-800 rounded-lg shadow-md h-[calc(100vh-50px)] overflow-y-auto">
                        <input
                            type="text"
                    ...
                    {/* Chat Box */}
                    <div className="flex-1 ml-4 bg-gray-800 p-4 rounded-lg shadow-md h-[calc(100vh-50px)] flex flex-col">
                        {/* Chat Header */}
                        ...
                        <div className="border-t border-gray-700 pt-3">
                            <div className="flex items-center">
                                ...
                                />
                                <button onClick={sendMessage} className="ml-2 p-2 bg-blue-600 text-white rounded-full">
